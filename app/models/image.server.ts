	...
	return [
		{
			id: 'memfeat',
			cName: 'feat',
			src: './assets/memory-game-feat.png',
		...
		},
		{
			id: 'ed520',
			cName: 'feat',
			src: './assets/Ed-Dining-520x400.jpg',
		...
		},
		{
			id: 'cont520',
			cName: 'feat',
			src: './assets/Cont-Client-520x400.png',
			title: 'Client Movie',
			description: 'Continental Services',
		},
		{
			id: 'ap520',
			cName: 'feat',
			src: './assets/Andre-Port-520x400.png',
...
export async function getImages(): Promise<Array<Image>> {
	return [
		...
		},
		{
			id: 'maps',
			cName: 'proj',
			src: './assets/neighborhood-maps.png',
		...
		},
		{
			id: 'gm305',
			cName: 'proj',
			src: './assets/GM-Power-305x320.png',
			title: 'GM Powertrain',
		...
		},
		{
			id: 'bala305',
			cName: 'proj',
			src: './assets/Balaboosta-305x320.png',
			title: 'Balaboosta',
		...
		},
		{
			id: 'ed305',
			cName: 'proj',
			src: './assets/Ed-Dining-305x320.png',
			title: 'Educational Dining',
		...
		},
		{
			id: 'cont305',
			cName: 'proj',
			src: './assets/Cont-Client-305x320.png',
			title: 'Client Movie',
		...
		},
		{
			id: 'rof305',
			cName: 'proj',
			src: './assets/Rise-of-Fall-305x320.png',
		...
		},
		{
			id: 'ap305',
			cName: 'proj',
			src: './assets/Andre-Port-305x320.png',
			title: 'Portfolio Magazine',
...
export async function getProjectImages(): Promise<Array<Image>> {
	return [
		...
		},
		{
			id: 'bala',
			cName: 'proj',
			src: './assets/projects/Balaboosta.png',
			title: 'Balaboosta',
		...
		},
		{
			id: 'ebroch',
			cName: 'proj',
			src: './assets/projects/ed-dining-brochure.png',
			title: 'Educational Dining',
			description: 'Stationery Collateral',
		},
		{
			id: 'efold',
			cName: 'proj',
			src: './assets/projects/ed-dining-folder.png',
			title: 'Educational Dining',
			description: 'Stationery Collateral',
		},
		{
			id: 'epos',
			cName: 'proj',
			src: './assets/projects/ed-dining-pos.png',
			title: 'Educational Dining',
			description: 'Stationery Collateral',
		},
		{
			id: 'greet',
			cName: 'proj',
			src: './assets/projects/GMGreeter_1.mp4',
			title: 'GM Powertrain',
			description: 'Greeter Board Mini',
		},
		{
		...
		},
		{
			id: 'rofpos',
			cName: 'proj',
			src: './assets/projects/rise-of-fall.png',
			title: 'The Rise of Fall Pasta',
			description: 'Point of Sales Flyer',
		},
	]
...
export async function getJobImages(): Promise<Array<Image>> {
	return [
		...
		},
		{
			id: 'continental',
			cName: 'logo',
			src: './assets/continental-logo.png',
			title: 'Continental',
			description: 'Logo',
